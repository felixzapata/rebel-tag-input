...
class RblTagInput extends HTMLElement {
    ...
    attachedCallback() {
        this.shadowRoot.innerHTML = `
            ...
            <label for="tag-input">Insert some tags:</label>
            <div class="rebel-tag-input" role="region" aria-relevant="additions removal" aria-atomic="true" aria-live="assertive">
